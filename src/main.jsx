...
const work = ['Citrus & Salt', 'Via Lento', 'The 6pm Table'];
...
function App() {
  ...
  return (
    <main>
      ...
      <section id="top" className="hero-fullscreen">
        ...
        <div className="hero-content">
          ...
          <h1 className="hero-headline">
            A little theatre, served.
            <br />
            <em>BLOOM</em>
          </h1>

          <p className="hero-dek">
            A bright, tactile culinary & botanical portfolio where menus unfold,
            gelato melts, and every detail earns a cinematic close-up.
          </p>
      ...
      <footer>
        <div className="footer-title">CRUMB &amp; BLOOM</div>
        <div>
